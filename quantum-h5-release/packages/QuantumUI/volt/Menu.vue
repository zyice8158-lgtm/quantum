...
const theme = ref<MenuPassThroughOptions>({
  ...
  list: `m-[0px] p-[2px] list-none outline-none flex flex-col gap-[2px]`,
  ...
  itemLabel: ``,
  submenuLabel: `bg-transparent py-[-12px] opacity-20 text-surface-500 dark:text-surface-400 font-semibold`,
