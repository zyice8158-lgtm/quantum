...
const theme = ref<ToastPassThroughOptions>({
    root: `w-[192px] rounded-md whitespace-pre-line break-words
    ...
    message: `mb-[8px] not-p-custom:border not-p-custom:backdrop-blur-sm dark:not-p-custom:backdrop-blur-md not-p-custom:rounded-md
    ...
    messageContent: `flex items-start p-[6px] gap-[4px]`,
    messageIcon: `flex-shrink-0 text-lg w-[1.125rem] h-[1.125rem] mt-[2px]`,
    messageText: `flex-auto flex flex-col gap-[4px]`,
    summary: `font-medium text-base`,
    detail: `font-medium text-sm`,
    buttonContainer: ``,
    closeButton: `flex items-center justify-center overflow-hidden relative cursor-pointer bg-transparent select-none
        transition-colors duration-200 text-inherit w-[14px] h-[14px] rounded-full -mt-[25%] -end-1/4 p-[0px] border-none
    ...
    closeIcon: `text-base w-[8px] h-[8px]`,
    transition: {
        ...
        leaveToClass: 'max-h-[0px] opacity-0 mb-[0px] overflow-hidden'
    }
});
</script>
